...
void generateMipmaps(VulkanCommandManager& vkcppCmdManager, VkPhysicalDevice physicalDevice, VkImage image, VkFormat imageFormat, int32_t texWidth, int32_t texHeight, uint32_t mipLevels) {
...
void transitionImageLayout(VulkanCommandManager& vkcppCmdManager, VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, uint32_t mipLevels) {
    VkCommandBuffer commandBuffer = vkcppCmdManager.beginSingleTimeCommands();
...
void copyBufferToImage(VulkanCommandManager& vkcppCmdManager, VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
    VkCommandBuffer commandBuffer = vkcppCmdManager.beginSingleTimeCommands();
